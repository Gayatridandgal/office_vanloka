    ...
    try {
      ...
      const { rows } = await client.query(
        ...
        [
          ...
          body.gender ?? null, body.dob ?? null, body.profilePhotoUrl ?? null,
          body.email ?? null, body.phone ?? null,
          body.emergencyContactName ?? null, body.emergencyContact ?? null,
          body.address ?? null, body.address2 ?? null, body.locality ?? null,
          ...
          body.preferredLanguage ?? null, body.interest ?? null,
          body.occupation ?? null, body.aimedLicenses ?? [],
          body.totalFee ?? 0, body.paidAmount ?? 0,
          body.trainingOnly ?? false,
