    ...
    try {
      ...
      const { rows } = await client.query(
        `INSERT INTO mds_instructors (
           ...
           cert_validity_start, cert_expiry_date,
           instructor_type, assigned_vehicle_id, vehicle_reg,
           languages_taught, training_modules,
           driving_school_name, driving_school_reg_no,
        ...
        [
          auth.user.org_id,
          body.firstName, body.lastName, body.gender ?? null, body.dob ?? null,
          body.profilePhotoUrl ?? null,
          body.email ?? null, body.mobile ?? null,
          body.emergencyContact ?? null, body.emergencyContactName ?? null,
          body.address1 ?? null, body.address2 ?? null, body.locality ?? null,
          body.city ?? null, body.district ?? null, body.state ?? null, body.pinCode ?? null,
          body.kycDocType ?? null, body.kycDocNumber ?? null,
          body.aadhaarNumber ?? null, body.panNumber ?? null,
          body.dlNumber ?? null, body.dlIssueDate ?? null,
          body.dlExpiryDate ?? null, body.licenseType ?? null,
          body.maritalStatus ?? null, body.bloodGroup ?? null,
          body.employeeId ?? null, body.drivingExperience ?? null,
          body.employmentType ?? null, body.hasInsurance ?? null,
          body.insurancePolicyNumber ?? null,
          body.medicalConditions ?? null, body.safetyTrainingCompleted ?? null,
          body.permitVerified ?? null,
          body.certificationNumber ?? null, body.certificationAuthority ?? null,
          body.certValidityStart ?? null, body.certExpiryDate ?? null,
          body.instructorType ?? "Instructor",
          body.assignedVehicleId ?? null, body.vehicleReg ?? null,
          body.languagesTaught ?? [], body.trainingModules ?? [],
          body.drivingSchoolName ?? null, body.drivingSchoolRegNo ?? null,
          body.digitalTrainingConsent ?? false,
          body.status ?? "Active", body.remarks ?? null,
        ],
      );

      return ok(rows[0]);
    } catch (e: any) {
      ctx.error("instructorsCreate:", e);
