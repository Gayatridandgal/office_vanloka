    ...
    try {
      ...
      const { rows } = await client.query(
        `UPDATE mds_instructors SET
           ...
           instructor_type     = COALESCE($9,  instructor_type),
           assigned_vehicle_id = COALESCE($10, assigned_vehicle_id),
           vehicle_reg         = COALESCE($11, vehicle_reg),
